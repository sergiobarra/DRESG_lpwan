...
num_trials = 300;                            % Number of trials (i.e. simulations) for averaging purposes
...
%             d_ring, aggregation_on, epsilon_initial(epsilon_ix), epsilon_tunning_mode, optimal_action, similarity_on, epsilon_initial_b);
%         
...
%         statistics_constant(trial_ix, epsilon_ix) = statistics;
        ...
        similarity_on = false;
        epsilon_initial_b = 0;
        epsilon_b_tunning_mode = EPSILON_GREEDY_CONSTANT;
        
        [action_history, reward_per_arm, statistics ] = ... 
            learn_optimal_routing( num_iterations, set_of_ring_hops_combinations,...
            d_ring, aggregation_on, epsilon_initial(epsilon_ix), epsilon_tunning_mode, optimal_action, similarity_on,...
            epsilon_initial_b, epsilon_b_tunning_mode, similarity_matrix);
...
%         epsilon_tunning_mode = EPSILON_GREEDY_CONSTANT;
%         similarity_on = true;
%         epsilon_b = 0.25;    % Greater means more exploration. Smaller means more exploitation of similar to best known action.
%         
%         [action_history, reward_per_arm, statistics ] = ... 
%             learn_optimal_routing( num_iterations, set_of_ring_hops_combinations,...
%             d_ring, aggregation_on, epsilon_initial(epsilon_ix), epsilon_tunning_mode, optimal_action, similarity_on, epsilon_b);
%         
...
%         similarity_on = true;
%         epsilon_b = 1;
%         epsilon_b_tunning_mode = EPSILON_GREEDY_DECREASING;
%         
%         [action_history, reward_per_arm, statistics ] = ... 
%             learn_optimal_routing( num_iterations, set_of_ring_hops_combinations,...
%             d_ring, aggregation_on, epsilon_initial(epsilon_ix), epsilon_tunning_mode, optimal_action,...
%             similarity_on, epsilon_b, epsilon_b_tunning_mode, similarity_matrix);
%         
