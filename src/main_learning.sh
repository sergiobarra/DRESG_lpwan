...
# -------------------------------------------------
#$ -o /homedtic/sbarrachina/dresg/job-out/output.out
#$ -e /homedtic/sbarrachina/dresg/job-out/error.err
#
#
# Start script
# --------------------------------
...
# Execute the script
/soft/MATLAB/R2015b/bin/matlab -nosplash -nodesktop -nodisplay -r "run /homedtic/sbarrachina/dresg/script/main_learning_parfor.m"
